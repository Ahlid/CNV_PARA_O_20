				...
				if (filename.endsWith(".class")) {
					...
					for (Enumeration e = ci.getRoutines().elements(); e.hasMoreElements(); ) {
						...
						for (Enumeration b = routine.getBasicBlocks().elements(); b.hasMoreElements(); ) {
							...
							bb.addBefore("pt/ulisboa/tecnico/meic/cnv/instrumentation/StatisticsTool", "dynInstrCount", new Integer(bb.size()));
						}
					}
					ci.addAfter("pt/ulisboa/tecnico/meic/cnv/instrumentation/StatisticsTool", "printDynamic", "null");
					...
					for (Enumeration e = ci.getRoutines().elements(); e.hasMoreElements(); ) {
						...
						for (Enumeration instrs = instructions.elements(); instrs.hasMoreElements(); ) {
							...
							if ((opcode==InstructionTable.NEW) ||
								...
								instr.addBefore("pt/ulisboa/tecnico/meic/cnv/instrumentation/StatisticsTool", "allocCount", new Integer(opcode));
							}
						}
					}
					ci.addAfter("pt/ulisboa/tecnico/meic/cnv/instrumentation/StatisticsTool", "printAlloc", "null");
					ci.write(out_filename);
				}
			}
		}
					...
					for (Enumeration e = ci.getRoutines().elements(); e.hasMoreElements(); ) {
						...
						for (Enumeration instrs = (routine.getInstructionArray()).elements(); instrs.hasMoreElements(); ) {
							...
							if (opcode == InstructionTable.getfield)
								instr.addBefore("pt/ulisboa/tecnico/meic/cnv/instrumentation/StatisticsTool", "LSFieldCount", new Integer(0));
							else if (opcode == InstructionTable.putfield)
								instr.addBefore("pt/ulisboa/tecnico/meic/cnv/instrumentation/StatisticsTool", "LSFieldCount", new Integer(1));
							else {
								short instr_type = InstructionTable.InstructionTypeTable[opcode];
								if (instr_type == InstructionTable.LOAD_INSTRUCTION) {
									instr.addBefore("pt/ulisboa/tecnico/meic/cnv/instrumentation/StatisticsTool", "LSCount", new Integer(0));
								}
								else if (instr_type == InstructionTable.STORE_INSTRUCTION) {
									instr.addBefore("pt/ulisboa/tecnico/meic/cnv/instrumentation/StatisticsTool", "LSCount", new Integer(1));
								}
							}
						}
					}
					ci.addAfter("pt/ulisboa/tecnico/meic/cnv/instrumentation/StatisticsTool", "printLoadStore", "null");
					ci.write(out_filename);
				}
			}	
		}
	...
	public static void doBranch(File in_dir, File out_dir) 
		{
			...
			for (int i = 0; i < filelist.length; i++) {
				...
				if (filename.endsWith(".class")) {
					...
					for (Enumeration e = ci.getRoutines().elements(); e.hasMoreElements(); ) {
						Routine routine = (Routine) e.nextElement();
						routine.addBefore("pt/ulisboa/tecnico/meic/cnv/instrumentation/StatisticsTool", "setBranchMethodName", routine.getMethodName());
						InstructionArray instructions = routine.getInstructionArray();
						for (Enumeration b = routine.getBasicBlocks().elements(); b.hasMoreElements(); ) {
							BasicBlock bb = (BasicBlock) b.nextElement();
							Instruction instr = (Instruction) instructions.elementAt(bb.getEndAddress());
							short instr_type = InstructionTable.InstructionTypeTable[instr.getOpcode()];
							if (instr_type == InstructionTable.CONDITIONAL_INSTRUCTION) {
								instr.addBefore("pt/ulisboa/tecnico/meic/cnv/instrumentation/StatisticsTool", "setBranchPC", new Integer(instr.getOffset()));
								instr.addBefore("pt/ulisboa/tecnico/meic/cnv/instrumentation/StatisticsTool", "updateBranchNumber", new Integer(k));
								instr.addBefore("pt/ulisboa/tecnico/meic/cnv/instrumentation/StatisticsTool", "updateBranchOutcome", "BranchOutcome");
								k++;
							}
						}
					}
					ci.addBefore("pt/ulisboa/tecnico/meic/cnv/instrumentation/StatisticsTool", "setBranchClassName", ci.getClassName());
					ci.addBefore("pt/ulisboa/tecnico/meic/cnv/instrumentation/StatisticsTool", "branchInit", new Integer(total));
					ci.addAfter("pt/ulisboa/tecnico/meic/cnv/instrumentation/StatisticsTool", "printBranch", "null");
					ci.write(out_filename);
				}
			}	
		}
