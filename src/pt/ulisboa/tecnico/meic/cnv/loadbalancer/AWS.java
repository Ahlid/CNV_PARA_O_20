...
public class AWS {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            AmazonDynamoDB ddb = new AmazonDynamoDB();
            ddb.init();
            String AMIImage = ddb.getAMIImage();
            ...
            for (Instance instance : instances) {
                ...
                String type = instance.getImageId().toString();
                if (state.equals("running")) {
                    runningInstances++;
                    //System.out.println("running instance id = " + name);
                    //System.out.println("running instance image = " + type);
            ...
            /* Using AWS Ireland. Pick the zone where you have AMI, key and secgroup */
                    ...
                    runInstancesRequest.withImageId(AMIImage)
                            .withInstanceType(INST_TYPE)
                            .withMinCount(1)
                            .withMaxCount(1)
                            .withKeyName(KEY_NAME)
