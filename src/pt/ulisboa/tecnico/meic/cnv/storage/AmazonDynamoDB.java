...
public class AmazonDynamoDB {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            String tableNameConfig = "myConfig";
            ...
            TableUtils.waitUntilActive(dynamoDB, tableNameConfig);
            ...
            // Add an item
            Map<String, AttributeValue> item = newConfigItem("AMI Name", "ami-bddadedb");
            PutItemRequest putItemRequest = new PutItemRequest(tableNameConfig, item);
